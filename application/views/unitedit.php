				  ...
				  <?php  foreach($data as $row) { ?>
                    <form method="post" enctype="multipart/form-data">
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-3">
                          <input type="text" value="<?php echo $row->punit_name; ?>" class="form-control" name="unit" id="category" placeholder="Enter Unit Name" required="required" style="height:33px; padding:4px;">
                        </div>
						
						 <div class="col-md-2">
                          <label for="name" value="<?php echo $row->qty; ?>" style="margin-top:6px; font-size:17px;"><b style='font-size:15px;'>Quantity</b></label>
                        </div>

                        <div class="col-md-3">
                          <input type="text" value="<?php echo $row->qty; ?>"  class="form-control" name="quantity" id="category" placeholder="Enter Quantity" required="required" style="height:33px; padding:4px;">
                        </div>
