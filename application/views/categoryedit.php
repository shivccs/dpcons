              ...
              <div class="col-md-12">
                <div class="card mb-4">
                  <div class="card-header">
                    <b style='font-size:15px;'>Edit Category </b>
                  </div>
				  ...
				  <?php  foreach($data as $row) { ?>
                    <form method="post" enctype="multipart/form-data">
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-3">
                          <input type="text" class="form-control" value="<?php echo $row->category_name; ?>" name="category" id="category" placeholder="Enter Category Name" required="required" style="height:33px; padding:4px;">
                        </div>
